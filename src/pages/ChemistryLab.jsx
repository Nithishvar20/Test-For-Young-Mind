...
const CHEM_EXPS = [
  {
    ...
    grade: "Acid-Base Neutralization",
    desc: "Perform acid-base titrations with virtual indicators and burettes. Observe real-time pH curves and equivalence points.",
  ...
  },
  {
    ...
    grade: "Collision Theory",
    desc: "Adjust concentration, temperature, and catalysts to see how they affect reaction speed. Visualize molecular collisions in real-time.",
  ...
  },
  {
    ...
    desc: "Connect electrodes and observe gas evolution during electrolysis. Learn Faraday’s laws of electrolysis and charge transfer.",
  ...
  return (
    <div
      style={{
        ...
        color: "#fff",
        background: theme, // ✅ theme applied here
      }}
    >
      {/* Header */}
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        <h1 style={{ fontSize: 42, fontWeight: 900, margin: 0 }}>Chemistry Lab</h1>
        <p style={{ marginTop: 12, fontSize: 16, color: "rgba(255,255,255,0.7)" }}>
          Choose an experiment and explore chemical reactions virtually.
        </p>
      </div>
